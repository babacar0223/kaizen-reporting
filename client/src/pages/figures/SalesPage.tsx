...
export default function SalesPage() {
  ...
  if (!selectedEntite) {
    return (
      <div className="flex flex-col items-center justify-center py-16 text-gray-400">
        <p className="text-sm">Select an entity from the filter above to view client-level sales data.</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-4">
      <div>
        <h2 className="text-base font-bold text-gray-900">Sales & Margin</h2>
        <p className="text-sm text-gray-400">{selectedEntite?.nom} · {MONTHS_EN[mois - 1]} {annee}</p>
      </div>

      {clients.length === 0 ? (
        <div className="text-center py-8 text-gray-400 text-sm">No Sales data for this entity / period</div>
      ) : (
          ...
          <table className="min-w-full text-xs">
            <thead>
              ...
              <tr className="bg-gray-50 border-b border-gray-200 text-gray-600 text-xs">
                ...
                <th colSpan={4} className="px-2 py-2 text-center font-semibold border-l border-gray-200 text-blue-700">Revenue</th>
                <th colSpan={4} className="px-2 py-2 text-center font-semibold border-l border-gray-200 text-teal-700">Gross Margin</th>
                <th className="px-2 py-2 text-center font-semibold border-l border-gray-200 text-gray-500" rowSpan={2}>Share</th>
              </tr>
              <tr className="bg-gray-50/80 border-b border-gray-200 text-gray-500 text-xs">
                ...
                <th className="px-2 py-2 text-right font-medium">vs Tgt</th>
                <th className="px-2 py-2 text-right border-l border-gray-200 font-medium">MTD</th>
                <th className="px-2 py-2 text-right font-medium">YTD</th>
