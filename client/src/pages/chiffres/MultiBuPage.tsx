...
export default function MultiBuPage() {
  ...
  if (isLoading) return <div className="text-center py-12 text-gray-500 text-sm">Chargement multi-BU...</div>;
  ...
  return (
    <div className="space-y-4">
      <div>
        <h2 className="text-lg font-bold text-gray-900">Vue Consolidée Multi-BU</h2>
        <p className="text-sm text-gray-500">YTD {moisLabel(mois)} {annee} · Toutes BU</p>
      </div>
        ...
        <table className="min-w-full text-xs">
          <thead>
            <tr className="bg-gray-50 border-b border-gray-200 text-gray-600">
              <th className="sticky left-0 bg-gray-50 text-left px-4 py-3 min-w-44 font-semibold">Ligne P&L</th>
              {BUS.map(bu => (
              ...
              <th colSpan={2} className="text-center px-3 py-3 font-semibold border-l border-gray-200 text-gray-800">Groupe Total</th>
            </tr>
